...
Load detailed guidance on demand using the Read tool:

| Topic | Path | Load When |
|-------|------|-----------|
| Modern PHP | `.agents/rules/php/references/modern-php-features.md` | Readonly, enums, attributes, fibers, types |
| Laravel | `.agents/rules/php/references/laravel-patterns.md` | Services, repositories, resources, jobs |
| Symfony | `.agents/rules/php/references/symfony-patterns.md` | DI, events, commands, voters |
| Async PHP | `.agents/rules/php/references/async-patterns.md` | Swoole, ReactPHP, fibers, streams |
| Testing | `.agents/rules/php/references/testing-quality.md` | PHPUnit, PHPStan, Pest, mocking |
