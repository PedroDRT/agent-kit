...
> **Arquivo anterior:** `knowledge/system/features/relatorio-contratos-por-cliente.md` (supersedido)
...
> ⚠️ **Atenção:** `CONTRATO FINAL DATA ATUAL` tem `vigencia_ate = 2026-04-10`. A partir de **2026-04-11**, este contrato passa a ser "Vencido". Atualizar o dado ou criar estratégia de dado dinâmico para CT001.5.
